...
vote = vote_ns.model('Vote', {
    ...
    'user_id': fields.Integer(readOnly=True, required=True, description='The id of the user that issued the vote'),
    'idea_id': fields.Integer(readOnly=True, required=True, description='The id of the idea that the vote belongs to'),
...
class IdeaResource(Resource):
    ...
    def get(self, vote_id):
        ...
        queried_idea = db.session.query(Vote).filter_by(id=vote_id).first()
